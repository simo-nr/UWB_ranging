...
//     If HW port uses EXT_IRQ line to receive ready/busy status from DW3xxx/QM33xx then mutex should use this signal
 ...
 * output parameters
 *
 * returns the state of the DW3xxx/QM33xx interrupt
 */
 ...
 *
 * input parameters:
 * @param s - the state of the DW3xxx/QM33xx interrupt as returned by decamutexon
 *
 * output parameters
 *
 * returns the state of the DW3xxx/QM33xx interrupt
