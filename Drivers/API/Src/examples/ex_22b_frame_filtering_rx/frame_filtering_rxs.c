...
int frame_filtering_rx(void)
{
    ...
    while (1)
    {
        ...
        if (status_reg & DWT_INT_RXFCG_BIT_MASK)
        {
            ...
            (void)rng_bit; /* Avoid compiler warning. */
            if (frame_len <= FRAME_LEN_MAX)
            {
                dwt_readrxdata(rx_buffer, frame_len, 0);
                test_run_info("Frame received");
            }
            ...
            {
                test_run_info("Beacon frame received");
            ...
            {
                test_run_info("Data frame received");
            ...
            {
                test_run_info("ACK frame received");
            ...
            {
                test_run_info("MAC frame received");
            ...
            {
                test_run_info("Reserved frame received");
            ...
            {
                test_run_info("Multipurpose frame received");
