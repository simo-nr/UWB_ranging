...
int simple_aes()
{
    ...
    dwt_write_scratch_data(tx_aes_job.header, tx_aes_job.header_len, 0);
    dwt_write_scratch_data(tx_aes_job.payload, tx_aes_job.payload_len, tx_aes_job.header_len);
    ...
    else
    {
        ...
        {
            dwt_read_scratch_data(enc_data, tx_aes_job.payload_len + tx_aes_job.header_len + tx_aes_job.mic_size, 0);
    ...
    else
    {
        ...
        {
            dwt_read_scratch_data(plain_data, rx_aes_job.payload_len + rx_aes_job.header_len + rx_aes_job.mic_size, 0);
