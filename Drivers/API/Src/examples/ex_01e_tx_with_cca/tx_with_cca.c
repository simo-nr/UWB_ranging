...
/* This constant would normally smaller (e.g. 1ms), however here it is set to 400 ms so that user can see (on the console) the report that the CCA detects a preamble on
