 ...
 *           (FAIL or OK) is printed on the console window. To have more information about which test is failing, the user can use a debugger to
 ...
 * Can be examined using a debugger to have more information on which test(s) is(are) failing when the console displays "TEST FAIL" */
